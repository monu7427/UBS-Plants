...
const page = () => {
  ...
  <div className="container px-6 py-12 mx-auto">
    <div>
      <p className="font-medium text-green-500 dark:text-blue-400">Contact us</p>
    ...
    <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
      <div>
        <span className="inline-block p-3 text-blue-500 rounded-full bg-green-100/80 dark:bg-gray-800">
